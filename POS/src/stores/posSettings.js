...
export const usePOSSettingsStore = defineStore("posSettings", () => {
	...
	const settings = ref({
		...
		allow_rate_change: 0, // Allow rate change
	...
	const kitchenPrintFormat = computed(() => settings.value.kitchen_print_format || "")
	...
	const enableItemSalesPerson = computed(() =>
		Boolean(settings.value.enable_item_sales_person)
	)
