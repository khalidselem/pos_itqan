...
frappe.ui.form.on('ITQAN Branding', {
...
function show_master_key_help() {
	const help_html = `
		<div class="master-key-help">
			...
			<p>The ITQAN branding is protected by a cryptographic master key system.</p>
			...
			<div class="alert alert-warning">
				...
				Contact ITQAN LLC support at <a href="mailto:info@itqan-kw.net">info@itqan-kw.net</a>
			</div>
		</div>
	`;
...
function show_tampering_stats() {
	frappe.call({
		method: 'pos_itqan.api.branding.get_tampering_stats',
		callback: function (r) {
			if (r.message) {
				...
				const stats_html = `
					<div class="tampering-stats">
						...
						<p class="text-muted">View detailed logs in <a href="/app/error-log?title=ITQAN%20Branding">Error Log</a></p>
					</div>
				`;
