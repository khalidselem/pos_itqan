...
class WalletTransaction(AccountsController):
	...
	def validate_amount(self):
		...
		if self.transaction_type == "Debit":
			from pos_itqan.pos_itqan.doctype.wallet.wallet import get_customer_wallet_balance
...
def credit_loyalty_points_to_wallet(customer, company, loyalty_points, conversion_factor=None):
	...
	from pos_itqan.pos_itqan.doctype.wallet.wallet import get_or_create_wallet
