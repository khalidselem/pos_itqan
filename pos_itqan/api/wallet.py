# Copyright (c) 2024, ITQAN LLC (info@itqan-kw.net, itqan-kw.com) and contributors
...
def process_loyalty_to_wallet(doc, method=None):
	...
	try:
		...
		from pos_itqan.pos_itqan.doctype.wallet_transaction.wallet_transaction import create_wallet_credit
...
def get_wallet_info(customer, company, pos_profile=None):
	...
	# Get wallet details (support both pos_itqan and wallete status values)
	wallet = frappe.db.get_value(
		"Wallet",
