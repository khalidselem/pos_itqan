...
from pos_itqan.api.utilities import check_user_company
from pos_itqan.api.utilities import _parse_list_parameter
...
def get_pos_settings(pos_profile):
	...
	from pos_itqan.api.constants import POS_SETTINGS_FIELDS, DEFAULT_POS_SETTINGS
